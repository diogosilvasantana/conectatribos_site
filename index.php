...
<head>
    ...
    <link href="includes/css/soon.min.css" rel="stylesheet">
    <!-- Materialize CSS -->
...
<body>
    ...
    <header>
        <div class="navbar-fixed">
            ...
            <div id="mobile-demo" class="side-nav">
                <ul>
                    <li><a href="#home"><span>HOME</span></a></li>
                    <li><a href="#evento"><span>O EVENTO</span></a></li>
                    <li><a href="#participacao"><span>PARTICIPAÇÃO EXCLUSIVA</span></a></li>
        ...
        <div id="home" class="section scrollspy parallax-container">
            ...
            <div class="row">
                <div class="col s12 logomarca">
                    <img src="includes/img/logo-site.png"><br>
                    <img src="includes/img/data-local.png">
                </div>
            </div>
...
<div class="contador hide-on-small-only">
                ...
                data-due="2018-08-11T10:00-03:00" 
                data-layout="group label-uppercase label-big" 
                data-scale-max="l"
                data-format="d,h,m,s" 
                data-face="slot" 
                data-visual="ring invert width-thick" 
                data-labels-days="Dias" 
                data-labels-hours="Horas" 
                data-labels-minutes="Minutos" 
                data-labels-seconds="Segundos">
                </div>
            </div>

            <div class="contador hide-on-large-only">
                <div class="soon" id="my-soon-counter" 
                data-due="2018-08-11T10:00-03:00" 
                data-layout="group label-uppercase label-big" 
                data-scale-max="xl"
  ...
  <ul class="collapsible z-depth-0">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="aviva-logo col l2 s12">
                    <a href="http://www.avivaviagens.com.br" target="_blank"><img src="includes/img/avivaviagens-logo.png"></a>
                </div>
            </div>
        </div>
            ...
            <div class="container">
                ...
                <div class="desenvolvedor">
                   <!-- <span>Desenvolvido por:</span><br> -->
                    <a class="grey-text text-lighten-4 right" href="http://www.dswebsolution.com.br" target="_blank"><img src="http://www.dswebsolution.com.br/images/logo.png"></a>
                </div>
                    </div>
                </div>
    ...
    <script src="includes/js/soon.min.js"></script>
